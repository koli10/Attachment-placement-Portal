...
// $res = $autonum->single_autonumber(2);
 @$empid = $_GET['id'];
  ...
  if ($emp->SEX == 'Male') {
   ...
   switch ($emp->Educationlevel) {

     case 'Single':
       # code...
        $Educationlevel =' <select class="form-control input-sm" name="Educationlevel" id="Educationlevel">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                             ...
                             <div class="form-group">
                              <div class="col-md-8">
                                <label class="col-md-4 control-label" for=
                                "Educationlevel">Civil Status:</label>

                                <div class="col-md-8">
                                  <?php echo $Educationlevel; ?>
                                </div>
                              </div>
                            </div> 
