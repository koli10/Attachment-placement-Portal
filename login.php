              ...
              <div class="modal-content">
                ...
                <!-- <form action="process.php?action=login" enctype="multipart/form-data" method="post"> -->
                  <div class="modal-body hold-transition login-page">
                    ...
                    <div class="login-box">
                        <div class="login-box-body" style="border: solid 1px #ddd;padding: 45px;min-height: 350px;">
                          ...
                          <a href="<?php echo web_root; ?>index.php?q=register" class="text-center">Don't have an account.Register Here</a>
