  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i></p>
        ...
        <div class="navbar navbar-default navbar-static-top" >
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Attachment Placement Portal<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li class="<?php echo !isset($_GET['q'])? 'active' :''?>"><a href="<?php echo web_root; ?>index.php">Home</a></li>
                        <li class="dropdown">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle">Attachment search <b class="caret"></b></a>
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle">Popular Attachment <b class="caret"></b></a>
                          <ul class="dropdown-menu">
                            <?php
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Haile Sellasie, Times tower<br>
           00200 Nairobi Kenya.</address>
          <p>
            <i class="icon-phone"></i> +254 456-789 - 1255-12584 <br>
            <i class="icon-envelope-alt"></i> placement_kenya@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Attachment Placement Portal All right reserved.
            </p>
          </div>
        </div>
        <div class="col-lg-6">
